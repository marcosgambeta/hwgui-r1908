...
HB_FUNC(HWG_OPENPRINTER)
{
  ...
  gnome_print_config_set(print->config, (const guchar *)"Settings.Transport.Backend.Printer",
                         (const guchar *)hb_parc(1));
...
HB_FUNC(HWG_SETPRINTERMODE)
{
  ...
  gnome_print_config_set(print->config, (const guchar *)GNOME_PRINT_KEY_PAGE_ORIENTATION,
...
HB_FUNC(HWG_GP_RECTANGLE)
{
  ...
  gnome_print_rect_stroked(print->gpc, (gdouble)x1, (gdouble)y1, (gdouble)(hb_parni(4) - x1 + 1),
                           (gdouble)(hb_parni(5) - y1 + 1));
}
...
HB_FUNC(HWG_GP_DRAWLINE)
{
  ...
  gnome_print_line_stroked(print->gpc, (gdouble)hb_parni(2), (gdouble)hb_parni(3), (gdouble)hb_parni(4),
                           (gdouble)hb_parni(5));
}
